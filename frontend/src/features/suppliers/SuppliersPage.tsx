...
function SupplierDetails({ supplier }: { supplier: Supplier }) {
  return <dl className="detail-grid"><div><dt>Nome</dt><dd>{supplier.nome}</dd></div><div><dt>CNPJ</dt><dd>{supplier.cnpj}</dd></div><div><dt>Cidade / Estado</dt><dd>{supplier.cidade} / {supplier.estado}</dd></div><div><dt>Rua</dt><dd>{supplier.rua}, {supplier.numero}</dd></div><div className="form-grid-wide"><dt>Complemento</dt><dd>{supplier.complemento || 'Não informado'}</dd></div></dl>
}
